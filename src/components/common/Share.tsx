...
export function Share(props: IShareProps) {
  return (
    <Popover>
      ...
      <PopoverContent
        className="portal:right-[50px] w-fit"
        sideOffset={5}
        alignOffset={10}
      >
        <div className="flex w-full flex-col gap-1">
          <label className="relative w-full">
            ...
            />
            <Input
              className="placeholder:font-italitc w-full border-slate-300 pl-12 text-black focus-visible:ring-0 focus-visible:ring-inset"
              placeholder="Enter your keyword to search"
              disabled
              type="text"
              value={"www://footypack.com/turf/asda"}
            />
            <Button
              variant={"secondary"}
              color="grey"
          ...
          <div className="flex gap-1">
            <Button size={"sm"} className="bg-blue-700">
              <Facebook className="fill-white pr-1 text-sm" />
              Facebook
            </Button>
            <Button size={"sm"} className="bg-blue-400">
              <Twitter className="fill-white pr-1 text-sm" />
              Twitter
            </Button>
