  ...
  return (
    <div>
        ...
        <div className="flex flex-col mt-8">
            <Card className="!z-5 relative flex flex-col rounded-[4px] max-w-[300px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 flex flex-col w-full !p-4 3xl:p-![18px] undefined">
